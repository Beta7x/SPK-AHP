            ...
            <div class="row">
                <div class="panel col-md-6 col-md-offset-3">
                    ...
                    <div class="panel-body">
                        ...
                        <p>Berikut merupakan hasil rekomendasi vitamin yang dihitung berdasarkan nilai bobot kriteria yang anda berikan</p>
                        <p>Hasil nilai ahp yang telah dihitung adalah sebesar <strong>{{ $DR->ahp }}</strong></p>
                        <p>Untuk melihat detail vitamin lebih lanjut Anda menekan link sebagai berikut : <a href="/detail/{{ $DR->tipe }}">{{ $DR->tipe }}</a></p>
                        <p style="margin-top: 500px;">
                            <div class="copyright">
                                &copy; Copyright <strong><span>SPK AHP</span></strong>. All Rights Reserved
                            </div>
                        </p>
                    </div>
                    @endforeach
