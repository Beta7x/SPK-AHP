  ...
  <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-item">
      <div class="carousel-container">
        ...
        <p class="animate__animated animate__fadeInUp">Sistem pendukung keputusan ini mendukung untuk membuat keputusan dalam pemilihan vitamin untuk balita sesuai dengan kriteria yang anda inginkan</p>
        <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
      </div>
    </div>
  ...
  <section id="about" class="about">
    <div class="container">
      ...
      <div class="row content" data-aos="fade-up">
        <div class="col-lg-6">
          <p>
            Sistem Pendukung Keputusan dalam pemilihan vitamin balita ini merupakan sistem informasi berbasis website yang dibangun menggunakan framework laravel.
          </p>
          <ul>
            <li><i class="ri-check-double-line"></i> Sistem ini bisa membantu anda dalam menentukan vitamin untuk balita yang anda inginkan </li>
            <li><i class="ri-check-double-line"></i> Sistem ini juga memiliki akurasi yang akurat dalam memberikan rekomendasi vitamin balita yang anda inginkan </li>
            <li><i class="ri-check-double-line"></i> Sistem ini menyajikan data vitamin untuk balita diambil melalui database terpercaya</li>
          </ul>
        </div>
        <div class="col-lg-6 pt-4 pt-lg-0">
          <p>
            Aplikasi ini dibuat untuk memudahkan pengguna dalam membuat keputusan atau sebagai alat referensi
            dalam pemilihan vitamin untuk balita yang diinginkan berdasarkan kriteria dan nilai yang bisa ditentukan sesuai kebutuhan
          </p>
    ...
    <div class="container">
      ...
      <ul class="nav nav-tabs row d-flex">
        ...
        <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="100">
          <a class="nav-link" data-toggle="tab" href="#tab-2">
            ...
            <h4 class="d-none d-lg-block">Data jenis-jenis vitamin balita yang bersertifikat</h4>
          </a>
        </li>
      ...
      <div class="tab-content" data-aos="fade-up">
        ...
        <div class="tab-pane" id="tab-2">
          <div class="row">
            <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
              <h3>Memiliki data jenis dan merk vitamin balita lebih dari 25 data</h3>
              <p>
                Sehingga membuat anda mampu menentukan banyak pilihan sesuai dengan kriteria vitamin bailat yang anda butuhkan
              </p>
              <p class="font-italic">
                Dilengkapi dengan gambar beragai macam merk vitamin balita yang memiliki sertifikat BPOM
              </p>
              <ul>
                <li><i class="ri-check-double-line"></i> Terdapat berbagai pilihan jenis vitamin balita</li>
    ...
    <div class="container">
      ...
      <div class="row" data-aos="zoom-out">
        <div class="col-lg-9 text-center text-lg-left">
          <h3>Coba Sekarang ?</h3>
          <p>Lakukan uji coba sistem pendukung keputusan dalam pemilihan vitamin balita hasil kalkulasi menggunakan metode ahp</p>
        </div>
    ...
    <div class="container">
      ...
      <ul class="faq-list">
        ...
        <li data-aos="fade-up" data-aos-delay="100">
          <a data-toggle="collapse" class="" href="#faq1">Data vitamin tidak terintegrasi<i class="icofont-simple-up"></i></a>
          <div id="faq1" class="collapse show" data-parent=".faq-list">
            <p>
              Data yang digunakan adalah data vitamin balita yang dijual pada apotek terdekat.
            </p>
          </div>
        </li>
        ...
        <li data-aos="fade-up" data-aos-delay="300">
          ...
          <div id="faq3" class="collapse" data-parent=".faq-list">
            <p>
              Alternatif yang tersedia untuk Sistem Pendukung Keputusan ini adalah beberapa daftar vitamin yang direkomendasikan.
            </p>
          </div>
        </li>
