				...
				<div class="auth-box ">
						...
						<div class="content">
							...
							<form class="form-auth-small" action="{{ route('postregister') }}" method="post">
								...
								<div class="form-group">
									...
									<input type="email" class="form-control" id="signin-email" name="email" placeholder="Masukkan Email">
								</div>
								<div class="form-group">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Sistem Pendukung Keputusan Pemilihan Vitamin</h1>
